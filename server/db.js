...
const dbPath = process.env.TEST_DB_PATH || path.join(__dirname, 'soriana.db');
...
db.serialize(() => {
    ...
    db.run(`INSERT OR IGNORE INTO payment_settings
        (id, sham_cash, syriatel_cash, mtn_cash, point_price)
        VALUES (1, '', '', '', 0)`);
